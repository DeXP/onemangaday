...
translate english day4_bb67bae4:
    ...
    lap "May be... But Andrew tried so hard!"

# game/day4.rpy:30
translate english day4_152a0959:

    # lap "И ведь это всё не важно! А я давно хотела спросить!"
    lap "After all, it's not important! I’ve always wanted to ask!"
...
translate english godQuestions_7c0e0536:
    ...
    god "Why I do with it? Am I a woman, or what?"
...
translate english day4afterGod_26c3e129:
    ...
    carry "Yes. I have all secret data."

# game/day4.rpy:119
translate english day4afterGod_4aade234:

    # carry "Да, при ближайшей оказии я передам Вам документы..."
    carry "Yes, at the earliest occasion, I will give you the documents..."
...
translate english day4afterGod_5710000f:
    ...
    lyblabla "So who has any suggestions?"

# game/day4.rpy:138
translate english day4afterGod_25859bf0:

    # lyblabla "И где Дэкс?!"
    lyblabla "And where is Dex?"
...
translate english day4afterGod_9dd6d454:
    ...
    # So, all this time he spied us! 
    mala "So, all this time he was peeping at us!"

# game/day4.rpy:196
translate english day4afterGod_86ed787e:

    # mala "Ну пускай только мне попадётся!"
    mala "Let only comes my way!"
...
translate english day4afterGod_d1573683:
    ...
    mala "Because of him, I never knew why Alex carries the damn keyboard!"
...
translate english day4afterGod_79e66e33:
    ...
    jess "Couple of juicy pictures of Dex, Malia and Alex!"

# game/day4.rpy:216
translate english day4afterGod_c7ccdba6:

    # lyblabla "Молодец, молодец. Делай ещё фотки!"
    lyblabla "Well done, well done. Do more pictures!"
...
translate english day4afterGod_e91e8662:
    ...
    mala "Well it is necessary, so it is necessary..."

# game/day4.rpy:280
translate english day4afterGod_8abecce5:

    # centered "И пошли они в бой." with dissolve
    centered "They went into the battle." with dissolve
...
translate english day4afterGod_a391e614:
    ...
    mala "Overall, it's evening already, time for dinner."
...
translate english day4afterGod_866ba9d6:
    ...
    dexp "Can we eat first? But tomorrow morning we will arrange showdown with a fresh mind."

# game/day4.rpy:294
translate english day4afterGod_1744e4d6:

    # lyblabla "Ужин - святое. Кушайте на здоровье."
    lyblabla "Dinner is sacred. Eat on health."

# game/day4.rpy:299
translate english day4afterGod_b3365918:

    # dexp "Да уж. Война войной, а еда по расписанию!"
    dexp "Yeah. War is war, and the food is on schedule!"
...
translate english day4afterGod_59b30c57:
    ...
    centered "That ended another day..." with dissolve

# game/day4.rpy:324
translate english day4afterGod_c1dae069:

    # centered "Выживут ли наши герои, или всё будет плохо?" with dissolve
    centered "Will survive our heroes, or all will be bad?" with dissolve
...
translate english godBadEnd_b1463d65:
    ...
    god "Now you'll stay in my world!!!"
...
translate english godBadEnd_a48cb482:
    ...
    centered "Eternity makes you thinking" with dissolve
...
translate english godBadEnd_007ef76e:
    ...
    centered "( P.S. Do not forget to find other endings! )" with irisout
...
translate english strings:
    ...
    new "How to understand a woman and your guide?"

    # game/day4.rpy:46
    old "Почему наши проекты всё время перехватывают?"
    new "Why are our projects intercepted all the time?"
    ...
    new "Where can I get free time?"

    # game/day4.rpy:175
    old "Что делать Дэксу?"
    new "What Dex should do?"

    # game/day4.rpy:175
    old "Панически скрыться!"
    new "Escape with panic!"
    ...
    new "Draw everything into a joke"
