...
translate english day7_59ad9557:
    ...
    dexp "But even work doesn’t help me to escape..."

# game/day7.rpy:57
translate english day7_ab96ff83:

    # dexp "Ты мне всё-таки нравишься!"
    dexp "I still like you!"

# game/day7.rpy:64
translate english day7_10ff111d:
...
translate english day7_fa3de326:
    ...
    dexp "I like you only as a сleaner."
...
translate english day7_b603f083:
    ...
    lap "Thank you, Dex! You know, I..."

# game/day7.rpy:73
translate english day7_cac45af2:

    # dexp "Но как девушка ты меня совершенно не интересуешь!"
    dexp "But I'm totally not interested in you, as a girl!"
...
# game/day7.rpy:81
translate english day7_cffae5ca:

    # dexp "Я сказал то, что считаю нужным..."
    dexp "I said what I think is necessary..."

# game/day7.rpy:95
translate english day7_d025abd9:
...
translate english day7_4a6c48d2:
    ...
    dexp "I'll explain!" with hpunch

# game/day7.rpy:116
translate english day7_816e7ac0:

    # centered "А тем временем" with dissolve
    centered "Meanwhile" with dissolve
...
translate english day7_f6f320ae:
    ...
    yana "Can Dex really translate to a human language!?"
...
translate english day7_3010a86b:
    ...
    carry "Record: \"a\", \"s\" and \"s\""

# game/day7.rpy:169
translate english day7_b35047eb:

    # lyblabla "Кэрри, что это ты делаешь..."
    lyblabla "Carrie, what are you doing..."
...
translate english day7_6edb0672:
    ...
    # Игра слов. Про мокрую воду. Пистолет водяной
    lyba "Yes! I'll dispatch you!"

# game/day7.rpy:184
translate english day7_11994b9e:

    # carry "Нет! Не надо!"
    carry "No! Don’t do that!"

# game/day7.rpy:185
translate english day7_73812992:

    # carry "Я жить хочу!"
    carry "I want to live!"
...
translate english day7_8b80f3e6:
    ...
    # carry "И я бы умерла?"
    carry "And I would have died?"

# game/day7.rpy:204
translate english day7_91c01621:

    # lyblabla "Нет конечно!"
    lyblabla "Of course not!"
...
# game/day7.rpy:214
translate english day7_66078864:

    # centered "Несколько позже, на крыше" with dissolve
    centered "Somewhat later, on the roof" with dissolve

# game/day7.rpy:220
translate english day7_63e79682:
...
translate english day7_a66e1074:
    ...
    dexp "We had some differences in our points of view, but let's work together now!"
...
translate english day7_f1f8f1c0:
    ...
    lyblabla "Now everything will be fine!"

# game/day7.rpy:246
translate english day7_7b4e8813:

    # lyblabla "О! У меня идея..."
    lyblabla "Oh! I have an idea..."

# А здесь пошла другая сюжетная ветка. Но в этих файлах части винегрет...
# game/day7.rpy:252
translate english day7_0b483caa:

    # lyblabla "Изначально я была против."
    lyblabla "Originally, I was against it."

# game/day7.rpy:254
translate english day7_47c56882:

    # lyblabla "И некоторые меня в этом поддерживают."
    lyblabla "Some team members support me in this."

# game/day7.rpy:255
translate english day7_41f06b8e:

    # lyblabla "Но раз большая часть команды хочет именно так..."
    lyblabla "But since most of the team wants it so..."
...
translate english day7_16ae26fd:
    ...
    dexp "If so, then I'm leaving!"

# game/day7.rpy:269
translate english day7_6a43d913:

    # ulilla "Хорошо, что мы смогли договориться!"
    ulilla "Good thing we were able to negotiate!"
...
# game/day7.rpy:275
translate english day7_a477d0c5:

    # lap "А где Дэкс?"
    lap "Where is Dex?"

# game/day7.rpy:277
translate english day7_f322250e:

    # lyblabla "Он ушёл."
    lyblabla "He's gone."

# game/day7.rpy:278
translate english day7_815271cb:

    # lap "Куда?"
    lap "Where?"

# game/day7.rpy:279
translate english day7_dbbd951f:
...
translate english shrineend_89bac185:
    ...
    centered "Everyone has their own memories" with dissolve

# game/day7.rpy:302
translate english shrineend_a719ee62:

    # centered "Воспоминания бывают хорошие, бывают плохие... Разные!" with dissolve
    centered "Some memories are good, some bad... There are different memories!" with dissolve
...
translate english shrineend_e6949663:
    ...
    centered "It is important that they are!" with dissolve
...
translate english shrineend_71c045ce:
    ...
    bab "Yeah, those were the times. How many years have already passed?"
...
translate english shrineend_7fdd75ee:
    ...
    bab "40 years... So many. It seems as if it was yesterday."
...
translate english shrineend_4a5fc13a:
    ...
    bab "You know how I was embarrassed?"

# game/day7.rpy:335
translate english shrineend_60aa768d:

    # bab "Говорить такое..."
    bab "Say that..."

# game/day7.rpy:337
translate english shrineend_2e3488b3:

    # bab "А ведь ты мне уже тогда нравился!"
    bab "Because I liked you already!"
...
# game/day7.rpy:376
translate english shrineend_c1b60f91:

    # centered "{size=36}{b}КОНЕЦ{/b}{/size}" with wipeleft
    centered "{size=36}{b}THE END{/b}{/size}" with wipeleft

# game/day7.rpy:386
translate english photoend_5e6fc80b:

    # centered "{size=36}{b}ХОРОШАЯ КОНЦОВКА{/b}{/size}" with wipeleft
    centered "{size=36}{b}GOOD ENDING{/b}{/size}" with wipeleft
...
translate english ending_photo_6c9cc0f4:
    ...
    lyblabla "You better sit down in a second row."

# game/day7.rpy:436
translate english ending_photo_809e4040:

    # carry "Эй! Меня не забудьте!"
    carry "Hey! You forgot me!"

# game/day7.rpy:440
translate english ending_photo_ecd05409:

    # carry "Хе-хей!"
    carry "Heh heh!"

# game/day7.rpy:444
translate english ending_photo_a103d9bb:
...
# game/day7.rpy:467
translate english ending_photo_8650668b:

    # lyblabla "Юль, сфотографируй нас пожалуйста!"
    lyblabla "Yulilla, please take a photo of us!"

# game/day7.rpy:469
translate english ending_photo_38b79246:

    # ulilla "Без проблем!"
    ulilla "No problem!"

# game/day7.rpy:474
translate english ending_photo_55ad0f28:

    # ulilla "Лайби! А ты каску снять забыла!"
    ulilla "Laiby! You forgot to take off the helmet!"

# game/day7.rpy:476
translate english ending_photo_047c6f5e:

    # lyblabla "Ой!"
    lyblabla "Oh!"

# game/day7.rpy:484
translate english ending_photo_8d6f64af:
...
translate english strings:
    ...
    # game/day7.rpy:60
    old "Нравишься только как клинер!"
    new "I like you only as a cleaner!"
    ...
    new "Working on the project together"

    # game/day7.rpy:226
    old "Отдать проект"
    new "Giving up this project"
